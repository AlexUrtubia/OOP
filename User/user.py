...
user1.make_deposit(15000)
user1.make_deposit(45000)
user1.display_user_balance()
# Haz que el segundo usuario haga 2 depósitos y 2 retiros y luego muestre su saldo
user2.make_deposit(350000)
user2.make_deposit(39700)
user2.make_withdrawal(290000)
user2.make_withdrawal(35000)
...
user3.make_withdrawal(5000)
user3.make_withdrawal(5000)
user3.make_withdrawal(5000) # Para comprobar error por falta de saldo
...
user1.transfer_money(user3,5000)
user1.display_user_balance()
user3.display_user_balance()